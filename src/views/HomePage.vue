        ...
        <FormField label="Email*">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 fill="none" class="w-5 h-5 opacity-70">
              <path d="M4 7.00005L10.2 11.65C11.2667 12.45
                       12.7333 12.45 13.8 11.65L20 7"
          ...
          <input v-model.trim="form.email" type="email" required
                 class="field-input" placeholder="e.g., example@gmail.com" />
        </FormField>
        ...
        <FormField label="Name*">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg"
                 class="h-5 w-5 opacity-70" viewBox="0 0 24 24"
                 fill="currentColor">
              <path d="M12 12c2.761 0 5-2.462
                       5-5.5S14.761 1 12 1
                       7 3.462 7 6.5 9.239 12 12 12zm0 2
                       c-4.418 0-8 2.91-8 6.5
                       0 .828.895 1.5 2 1.5h12c1.105 0
                       2-.672 2-1.5 0-3.59-3.582-6.5-8-6.5z"/>
            </svg>
          </template>
          <input v-model.trim="form.name" type="text" required
                 class="field-input" placeholder="e.g., Diana" />
        </FormField>
        ...
        <FormField label="Birthdate*">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg"
                 class="h-5 w-5 opacity-70" viewBox="0 0 24 24"
                 fill="currentColor">
              <path d="M7 2a1 1 0 1 0 0 2h1v1h8V4h1a1 1
                       0 1 0 0-2H7zM4 7a3 3 0 0 1
                       3-3h10a3 3 0 0 1 3 3v11a3 3
                       0 0 1-3 3H7a3 3 0 0 1-3-3V7zm3
                       3h4v4H7v-4z"/>
            </svg>
          </template>
        ...
        <FormField label="Country you were born in*">
          <template #icon>
            <svg xmlns="http://www.w3.org/2000/svg"
                 class="h-5 w-5 opacity-70" viewBox="0 0 24 24"
                 fill="currentColor">
              <path d="M12 2C6.486 2 2 6.486 2 12
                       c0 6.213 6.234 9.66 9.36 9.95.422.04.64-.186.64-.414v-2.1
                       c-3.803.858-4.6-1.614-4.6-1.614
                       -.384-.996-.94-1.263-.94-1.263
                       -.768-.54.06-.53.06-.53.85.06
                       1.298.9 1.298.9.755 1.32
                       1.983.94 2.466.72.076-.56.296-.94.54-1.157
                       -3.036-.346-6.228-1.548-6.228-6.892
                       0-1.522.53-2.766 1.398-3.74
                       -.14-.346-.606-1.74.14-3.62
                       0 0 1.146-.37 3.76 1.43
                       1.09-.308 2.26-.462 3.42-.468
                       1.16.006 2.33.16 3.42.468
                       2.614-1.8 3.76-1.43 3.76-1.43
                       .746 1.88.28 3.274.14 3.62
                       .868.974 1.398 2.218 1.398 3.74
                       0 5.356-3.2 6.542-6.248 6.882
                       .306.27.58.804.58 1.626v2.41
                       c0 .232.216.458.646.414
                       C15.77 21.66 22 18.21 22 12
                       c0-5.514-4.486-10-10-10z"/>
            </svg>
          </template>
          <input v-model.trim="form.country" type="text" required
                 class="field-input" placeholder="e.g., USA" />
        </FormField>
          ...
          <div class="relative rounded-2xl p-[1.5px] bg-gradient-to-r from-fuchsia-500/60 via-indigo-500/60 to-violet-500/60 animate-border">
            <div class="relative rounded-2xl bg-white/5 backdrop-blur-md px-5 py-4 overflow-hidden">
              ...
              <div class="mt-4 relative h-2 rounded-full bg-white/10 overflow-hidden">
                ...
                <div class="h-full rounded-full bg-gradient-to-r from-fuchsia-400 via-indigo-400 to-violet-400 transition-all duration-200 ease-out"
...
// плавная анимация прогресса (rAF)
function animateProgress(duration = 5000, onFinish) {
...
.field-input {
  @apply w-full pl-11 pr-3 py-3 rounded-2xl bg-white/5 border border-white/10
  text-white placeholder-purple-300/60 focus:outline-none
  focus:border-fuchsia-400/50 focus:ring-2 focus:ring-fuchsia-400/30 transition;
}
</style>
